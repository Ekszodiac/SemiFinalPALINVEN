...
Public Class PALInvenReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PAL_Inventory_System.PALInvenReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPALInvenReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PALInvenReport = New PALInvenReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
