...
Public Class PALInventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PAL_Inventory_System.PALInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPALInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PALInventory = New PALInventory()
        rpt.Site = Me.Site
        Return rpt
    End Function
